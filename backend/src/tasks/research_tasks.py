...
def create_sentiment_analysis_task(agent: Agent) -> Task:
    ...
    task = Task(
        description=(
            ...
            "2. For EACH ticker, use the 'News Sentiment Analyzer' tool with the ticker "
            "   symbol as the query and max_articles=5.\n"
            "3. Compile sentiment results for ALL tickers.\n"
            ...
            "   }\n\n"
            "CONSTRAINTS:\n"
            "- You MUST use the News Sentiment Analyzer tool for each ticker.\n"
